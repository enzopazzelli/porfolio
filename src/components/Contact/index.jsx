    ...
    <div name='contacto' className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
      <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
        <div className='pb-8'>
          ...
          <p className='py-6'>Completa el formulario para ponerte en contacto conmigo</p>
        </div>

        <div className='flex justify-center items-center'>
          <form action="https://getform.io/f/b3b1f17e-900d-4d3a-bebb-ebd6e175253c" method='POST' className='flex flex-col w-full md:w-1/2'>
            <input type="text" name='name' placeholder='Escribe tu nombre' className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none'/>
            <input type="text" name='email' placeholder='Escribe tu correo' className='my-4 p-2 bg-transparent border-2 rounded-md text-white focus:outline-none'/>
